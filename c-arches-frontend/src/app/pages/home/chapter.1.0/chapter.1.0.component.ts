...
export class Chapter10Component {
  ...
  dialogueLines : DialogueLine[] = [
    ...
    { speaker: 1, message: "Hey, Sam.", params: []},
    ...
    { speaker: 1, message: "He denied it, but I know he took it.", params: []},
    { speaker: 0, message: "Dude, what?", params: []},
    { speaker: 1, message: "It made me really uncomfortable.", params: []},
    ...
    { speaker: 0, message: "He has no right to force you into something you’re not ready for.", params: []},
    { speaker: 1, message: "I think he was poking holes in the condoms before...", params: []},
