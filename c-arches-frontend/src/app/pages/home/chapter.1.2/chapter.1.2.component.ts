...
export class Chapter12Component {
  ...
  dialogueLines : DialogueLine[] = [
    ...
    { speaker: 0, message: "Who else knows about this?", params: []},
    { speaker: 1, message: "I haven't really talked to anyone...", params: []},
    { speaker: 0, message: "...I'm kinda embarassed.", params: []},
    { speaker: 1, message: "Okay, well you don't have to go through this alone.", params: []},
    { speaker: 0, message: "Have you considered getting on something that your partner can't mess with?", params: []},
    { speaker: 1, message: "What do you mean?", params: []},
    { speaker: 0, message: "Well, you could get the birth control shot, implant, or IUD.", params: []},
    { speaker: 1, message: "Oh...maybe?  I don't want to worry about getting pregnant!", params: []},
    ...
    { speaker: 1, message: "Thanks, Sam.", params: []},
    { speaker: 0, message: "Anytime, Jade.", params: []},
  ];
