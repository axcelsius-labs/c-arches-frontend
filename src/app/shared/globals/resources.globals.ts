...
export const resources: Resource[] = [
  ...
  },
  {
    name: 'myPlanApp',
    description:
      'If you or someone you are about is experiencing abuse in their relationship, download the myPlan app to help with safety decisions',
  ...
  },
  {
    ...
    description:
      '24/7 confidential and free support for survivors and loved ones.',
  ...
  },
  {
    ...
    description:
      'For confidential domestic/sexual violence support, specifically for Native communities',
  ...
  },
  {
    name: 'Trans LifeLine',
    description:
      'A peer-support hotline staffed exclusively by trans operators. The only crisis line with a policy against non-consensual active rescue.',
